...
const FormActionContainer =(props)=>{
     const {action,actionClick,operationClick,toastAction,setToastAction} = props;
    ...
    <div id="header-action">
      ...
      {action=='view' && (
        <div className="action-header">
          ...
          <Button className="btn-action" label="Add New" onClick={() => handleAction('add')} severity="danger" text   />
          </div>
      </div>
    )}
    </div>
